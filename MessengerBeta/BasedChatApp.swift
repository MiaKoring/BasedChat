...
let testFormattedChars = [FormattedChar(char: "Hallo~ ich ", formats: []), FormattedChar(char: "bin ", formats: ["_"]), FormattedChar(char: "Mia", formats: ["_", "*"]), FormattedChar(char: " lol", formats: ["*"]), FormattedChar(char: " ", formats: []), FormattedChar(char: "Test ", formats: ["~"]), FormattedChar(char: "123", formats: ["~", "_"]), FormattedChar(char: "", formats: ["~"])]
